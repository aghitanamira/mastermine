                    ...
                    <form class="md-float-material form-material">
                        <div class="auth-box card">
                            <div class="card-block">
                                ...
                                <form action="/mastermine/login" method="post">
                                    ...
                                    <div class="row m-t-30">
                                        <div class="col-md-12">
                                            <a href="/mastermine"><button type="button" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20">Sign in</button> </a>
                                        </div>
                                    </div>
                                    <center>
                                        <div>
                                            <p> Don't have account?</p>
                                            <a href="/mastermine/register"> Sign Up</a>
                                        </div>
                                    </center>
                                </form>
                            </div>
