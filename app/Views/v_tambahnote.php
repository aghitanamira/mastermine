...
<head>
    ...
    <!-- font-awesome-n -->
    <link rel="stylesheet" type="text/css" href="/assets/material_able-main/assets/css/font-awesome-n.min.css">
    <link rel="stylesheet" type="text/css" href="/assets/material_able-main/assets/css/font-awesome.min.css">
    <!-- scrollbar.css -->
                                            ...
                                            <div class="card-block">
                                                ...
                                                <form>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" placeholder="Type title note here...">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Category</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" placeholder="Type category note here...">
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        <label class="col-sm-2 col-form-label">Description</label>
                                                        <div class="col-sm-10">
                                                            <textarea rows="5" cols="5" class="form-control" placeholder="Type your description note here..."></textarea>
                                                        </div>
                                                    </div>
                                                    <div class="">
                                                        <button type="button" class="btn btn-primary pull-right" style="position: right;">CREATE</button>
                                                    </div>
                                                </form>
